...
Pikes_Data <- Pikes_Data %>%  
  mutate( 
    ...
    bindata= cut(eU, c(0, 250,500,1000,2500)) #these are my bin cutoffs
  ) 
```
...
Pikes_lowelevation_heftyplt<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Pikes") %>% filter(data_subset == "LOW"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'magenta' ) +
  geom_vline(xintercept = 250, linetype = "dashed") +  
  geom_vline(xintercept = 500,linetype="dashed")  + 
  geom_vline(xintercept = 1000,linetype="dashed")  + 
...
Pikes_highelevation_heftyplt<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Pikes") %>% filter(data_subset == "HIGH"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'green' ) +
  geom_vline(xintercept = 250, linetype = "dashed") +  
  geom_vline(xintercept = 500,linetype="dashed")  + 
  geom_vline(xintercept = 1000,linetype="dashed")  + 
...
ME1_Hefty<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Evans") %>% filter(data_subset == "LOW"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'green' ) +
  geom_vline(xintercept = 250, linetype= "dashed")  + 
  geom_vline(xintercept = 500, linetype = "dashed") +  
  geom_vline(xintercept = 1000,linetype="dashed")  + 
...
Evans_highelevation_hefty<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Evans") %>% filter(data_subset == "HIGH"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'magenta' ) +
...
Longs_highelevation_hefty<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Longs") %>% filter(data_subset == "HIGH"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'green' ) +
  geom_vline(xintercept = 500, linetype= "dashed")  + 
  geom_vline(xintercept = 1000, linetype = "dashed") +  
...
Longs_lowelevation_hefty<- ggplot () + 
  ...
  geom_point(data = model_outcomes %>% filter(Peak == "Longs") %>% filter(data_subset == "LOW"), aes(x = eU, y=model_age), pch =25, size = 6, fill = 'magenta' ) +
  geom_vline(xintercept = 500, linetype= "dashed")  + 
  geom_vline(xintercept = 1000, linetype = "dashed") +  
  labs(x="eU (ppm)", y = "Date (Ma)", title= "Longs Peak, elevation <= 3500 m") +
  scale_x_continuous(expand=c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
