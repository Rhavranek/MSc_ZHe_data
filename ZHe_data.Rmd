...
Pikes_Data <- Pikes_Data %>%  
  mutate( 
    ...
    bindata= cut(eU, c(0,100, 250,500,1000,2500)) #these are my bin cutoffs
  ) 
```
...
Pikes_lowelevation_hefty <- Pikes_Data %>% filter (papername == "PP1" | papername == "PP2" | papername == "PP3") %>% filter (!Donotuse) %>% 
  group_by(bindata) %>% 
    summarize( 
      ...
      mean_rs = round(mean(Grain_size), digits = 1),
      CorrDate_mean = round(mean(date), digits = 1),
      CorrDate_15percent = round(0.15*mean(date),digits = 1),
      CorrDate_SD = round (sd(date), digits = 1),
      N = n(),
...
Pikes_lowelevation_heftyplt<- ggplot () + 
  geom_point(data=Pikes_Data %>% filter (!Donotuse) %>% filter (papername == "PP1" | papername == "PP2" | papername == "PP3"), aes( x=eU, y=date, label = papername, text = replicate, ), fill = 'gray60', pch=22, size=4, ) + 
  geom_errorbar(data = Pikes_lowelevation_hefty, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1) +
  geom_point(data = Pikes_lowelevation_hefty, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 100, linetype= "dashed")  + 
  geom_vline(xintercept = 250, linetype = "dashed") +  
  geom_vline(xintercept = 500,linetype="dashed")  + 
  geom_vline(xintercept = 1000,linetype="dashed")  + 
  labs(x="eU (ppm)", y = "Date (Ma)", title = "PP1, PP2 and PP3 Hefty Modeling Bins" ) +  
  scale_x_continuous(expand =c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
  scale_y_continuous(expand =c(0,0), limits = c(0,800), breaks=seq(0, 800, 200)) +
  theme_classic()+
  theme(
...
Pikes_highelevation_heftyplt<- ggplot () + 
  geom_point(data=Pikes_Data %>% filter (!Donotuse) %>% filter (papername != "PP1" & papername != "PP2" & papername != "PP3"), aes( x=eU, y=date, label = papername, text = replicate, ), fill = 'gray60', pch=22, size=4, ) + 
  geom_errorbar(data = Pikes_highelevation_hefty, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1) +
  geom_point(data = Pikes_highelevation_hefty, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 100, linetype= "dashed")  + 
  geom_vline(xintercept = 250, linetype = "dashed") +  
  geom_vline(xintercept = 500,linetype="dashed")  + 
  geom_vline(xintercept = 1000,linetype="dashed")  + 
  labs(x="eU (ppm)", y = "Date (Ma)",  title = "PP4, PP5 and PP6 Hefty Modeling Bins" ) +  
  scale_x_continuous(expand =c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
  scale_y_continuous(expand =c(0,0), limits = c(0,800), breaks=seq(0, 800, 200)) +
  theme_classic()+
  theme(
...
ME1_flatlist <- Mount_Evans %>% filter (Sample == "ME1_2872") %>% 
  mutate(bindata= cut(eU, c(0,250, 500,1000))) %>%  #these are my bin cutoffs
  group_by(bindata) %>% 
    summarize( 
...
ME1_Hefty<- ggplot () + 
  geom_point(data=Mount_Evans %>% filter (Sample == "ME1_2872"), aes(x=eU, y=Corr_Date, label = Sample, text = Grain, ), fill = 'gray60', pch=22, size=4) + 
  geom_errorbar(data = ME1_flatlist, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1)+
  geom_point(data = ME1_flatlist, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 250, linetype= "dashed")  + 
  geom_vline(xintercept = 500, linetype = "dashed") +  
  geom_vline(xintercept = 1000,linetype="dashed")  + 
  labs(x="eU (ppm)", y = "Date (Ma)", title = "Mount Evans < 3500 m (ME1)")  +
  scale_x_continuous(expand=c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
  scale_y_continuous(expand=c(0,0), limits = c(0,800), breaks=seq(0, 800, 200)) +
  theme_classic() +
  theme(
...
Evans_highelevation_hefty<- ggplot () + 
  geom_point(data = Mount_Evans %>% filter (Sample != "ME1_2872") %>% filter (!Donotuse), aes(x=eU, y=Corr_Date, label = Sample, text = Grain), fill = 'gray60', pch=22, size=4)+ 
  geom_errorbar(data = ME_highelevation_flatlist, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1)+
  geom_point(data = ME_highelevation_flatlist, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 450, linetype = "dashed") +  
  geom_vline(xintercept = 1000,linetype="dashed")  + 
  labs(x="eU (ppm)", y = "Date (Ma)", title = "Mount Evans > 3500 m")  +
  scale_x_continuous(expand=c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
  scale_y_continuous(expand=c(0,0), limits = c(0,800), breaks=seq(0, 800, 200)) +
  theme_classic() +
  theme(
...
LP_ED_byeU<-ggplot(data=Longs_Peak, aes(Corr_Date, Elevation))+
  ...
  viridis::scale_fill_viridis(option = "viridis", limits=c(0,2000))+
  geom_point(data=AFT_data %>% filter (Peak == "Longs Peak"), aes(AFT_date, Elevation), pch=18, size=4)+
  theme_classic()+
...
Longs_highelevation_hefty<- ggplot () + 
  geom_errorbar(data = LP_highelevation_flatlist, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1)+
  ...
  geom_point(data = LP_highelevation_flatlist, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 500, linetype= "dashed")  + 
  geom_vline(xintercept = 1000, linetype = "dashed") +  
...
Longs_lowelevation_hefty<- ggplot () + 
  geom_errorbar(data = LP_lowelevation_flatlist, aes(x=eU, ymin = CorrDate_mean - CorrDate_SD, ymax = CorrDate_mean + CorrDate_SD), color = 'black', width=.1)+
  geom_point(data=Longs_Peak %>% filter (!Donotuse) %>% filter (Elevation  <= 3500), aes(x=eU, y=Corr_Date, label = papername, text = Grain), fill = 'gray60', pch=22, size=4) + 
  geom_point(data = LP_lowelevation_flatlist, aes(x = eU, y = CorrDate_mean), pch = 21, size = 6, fill = 'darkgreen') +
  geom_vline(xintercept = 500, linetype= "dashed")  + 
  geom_vline(xintercept = 1000, linetype = "dashed") +  
  labs(x="eU (ppm)", y = "Date (Ma)", title= "Longs Peak, elevation <= 3500 m") +
  scale_x_continuous(expand=c(0,0), limits=c(0,2400), breaks=seq(0, 2400, 400)) + 
